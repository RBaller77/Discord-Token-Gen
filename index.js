...
async function fill_discord(DiscordPage, username, password, email){
  ...
  await fill_input(DiscordPage, "username", "!Baller | " + Math.random().toString(36).substring(2, 7) + "\n");
  await fill_input(DiscordPage, "password", '8088888888888888');
...
async function create_accinfos(browser, d) {
  ...
  write_log(true, `Username: 'baller'`);
  write_log(true, `Password: '8088888888888888888'`);
